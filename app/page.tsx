...
export default function HomePage() {
  return (
    <div className="scroll-snap-y h-screen overflow-y-auto">
      ...
      {/* <Link
        href="/dashboard"
        className="fixed bottom-4 right-4 z-50 p-3 bg-foreground/10 hover:bg-foreground/20 border border-foreground/20 rounded-full transition-all text-xs flex items-center gap-2 backdrop-blur-sm"
