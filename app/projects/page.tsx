...
const SAMPLE_PROJECTS = [
  {
    ...
    description:
      "An intelligent task management app that uses AI to prioritize and categorize your daily tasks automatically.",
    shortLink: "ai-task",
  ...
  },
  {
    ...
    description:
      "Real-time weather tracking for all districts in Sri Lanka with beautiful visualizations.",
  ...
  },
  {
    ...
    description:
      "A collaborative platform for developers to share and discover useful code snippets.",
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                  ...
                  <div className="space-y-1">
                    <label className="font-mono text-xs text-purple-400">
                      project_name<span className="text-red-400">*</span>
                    </label>
                    <Input
                  ...
                  <div className="space-y-1">
                    <label className="font-mono text-xs text-blue-400">
                      linkedin_url
                    </label>
                    <Input
